...
update_directory(const char* path, const char* unmount_when_done) {
    ...
    const char* MENU_HEADERS[] = { "Elija el paquete a instalar:",
                                   path,
                                   "",
                                   NULL };
    DIR* d;
...
wipe_data(int confirm) {
    if (confirm) {
        ...
        char* items[] = { " No",
                          ...
                          " No",
                          " No",
                          " Si -- Borrar Todos los datos de Usuario",   // [7]
                          " No",
                          " No",
                          " No",
                          NULL };
